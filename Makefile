...
firmware.elf: cmsis_core cmsis_f4 hal.h link.ld Makefile $(SOURCES) mongoose/mongoose.h
...
cmsis_f4:
	git clone -q -c advice.detachedHead=false --depth 1 -b v2.6.9 https://github.com/STMicroelectronics/cmsis_device_f4 $@
